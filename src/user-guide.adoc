...
* *Temporary Group* : Lasso a sketch with finger
* *Persistent Group* : Lasso a sketch with finger and tap the group icon
...
1. Lasso a sketch with finger -> A temporary group is created.
2. Tap the group icon on the bottom toolbar


==== Ungroup

1. Tap a group with finger -> It's selected.
